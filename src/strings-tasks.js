 ...
 *   getFirstChar('') => ''
 */
function getFirstChar(someText) {
  return someText.charAt(0);
}
 ...
 */
function removeLeadingAndTrailingWhitespaces(someString) {
 ...
 */
function removeLeadingWhitespaces(someString) {
  return someString.trimStart();
}
 ...
 */
function removeTrailingWhitespaces(someString) {
  return someString.trimEnd();
}
 ...
 *   repeatString('abc', -2) => ''
 */
function repeatString(someString, repeatTimes) {
  if (repeatTimes < 0) {
    return '';
  }
  return someString.repeat(repeatTimes);
}
 ...
 */
function removeFirstOccurrences(someString, substring) {
  if (someString.indexOf(substring) >= 0) {
    return someString.replace(substring, '');
  }
  return someString;
}
 ...
 */
function removeLastOccurrences(someString, substring) {
  if (someString.lastIndexOf(substring) >= 0) {
    return (
      someString.slice(0, someString.lastIndexOf(substring)) +
      someString.slice(someString.lastIndexOf(substring) + substring.length)
    );
  }
  return someString;
}
 ...
 *   sumOfCodes() => 0
 */
function sumOfCodes(someString) {
  let sum = 0;
 ...
 */
function startsWith(someSting, substr) {
  return someSting.startsWith(substr);
}
 ...
 */
function endsWith(someString, substr) {
  return someString.endsWith(substr);
}
